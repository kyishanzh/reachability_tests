...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \end{enumerate}
        \item kNN induces an empirical conditional: \textcolor{red}{think about this more}\[\hat{p}_{\text{kNN}}(Q \mid H') = \sum_{j \in \mathcal{N}_k(H')} w_j (H') \delta (Q - Q_j)\qquad w_j \propto \exp(-||H_j - H'||^2 / \sigma^2)\]
    \end{itemize}
    ...
    \end{itemize}
    \textcolor{red}{Read into theory behind this way more}
    \item \textit{Invertible NN} (FrEIA): \textcolor{red}{Read into theory behind this way more}
    \begin{itemize}
...
\subsection{cVAE theory}

\subsubsection{ELBO loss}

\subsection{FrEIA INN theory}
