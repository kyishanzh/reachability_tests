...
\begin{itemize}
    ...
    \begin{itemize}
        \item Input: $Q_{\text{feat}}$ (+ empty conditioning vector $C$ )
        \item Goal: Model learns distribution $p(Q_\text{feat} \mid C)$ that maximizes the predicted probability of seeing the ground truth data distribution $(Q_{\text{feat}}, C)$ pairs.
    \end{itemize}
...
\subsubsection{Conditional INN} \textbf{Metrics to track:}
\begin{itemize}
    \item FILL IN
\end{itemize}
